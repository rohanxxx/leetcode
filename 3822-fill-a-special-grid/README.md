<h2><a href="https://leetcode.com/problems/fill-a-special-grid/description/?envType=company&envId=google&favoriteSlug=google-thirty-days">3822. Fill a Special Grid</a></h2><h3>Medium</h3><hr><p>You are given a non-negative integer <code><font face="monospace">n</font></code> representing a <code>2<sup>n</sup> x 2<sup>n</sup></code> grid. You must fill the grid with integers from 0 to <code>2<sup>2n</sup> - 1</code> to make it <strong>special</strong>. A grid is <strong>special</strong> if it satisfies <strong>all</strong> the following conditions:</p>
